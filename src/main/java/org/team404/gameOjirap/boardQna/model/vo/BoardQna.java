package org.team404.gameOjirap.boardQna.model.vo;

import java.sql.Date;

public class BoardQna implements java.io.Serializable{
	private static final long serialVersionUID = -991232019778736222L;
	...
	public BoardQna(int board_no, String board_title, String board_content, Date date, int board_count, String appid,
