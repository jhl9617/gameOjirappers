	...
	<div id="wrapper">
		...
		<div id="main">
			<div class="inner">
				...
				<!-- Header -->
				<header id="header">
					<a href="index.html" class="logo"><strong>겜지라퍼</strong> by team 404</a>
					<ul class="icons">
				...
				<section>
					<header class="main">
						<h1 align="center">게임 이름 자리</h1>
					</header>
					<!--게임사진 들어갈 부분 -->
					<span class="image main"><img src="images/pic11.jpg" alt="" /><h1><a href="${pageContext.servletContext.contextPath}/updateGameInfo.do" >이미지자리</a></h1></span>
					<table>
					<tr>
					<td>
					<div style="border:1px solid black;">Donec eget ex magna. Interdum et malesuada fames ac ante
						...
						elementum convallis elit. Pellentesque enim turpis, hendrerit.</div></td>
					<td>
					<div style="border:1px solid black;">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
						...
						vel sed vehicula.</div>
						</td>
						<td>
					<div style="border:1px solid black;">Interdum et malesuada fames ac ante ipsum primis in
						...
						Pellentesque enim turpis, hendrerit tristique lorem ipsum dolor.</div>
						</td>
						</tr>
					</table>
					<hr class="major" />
